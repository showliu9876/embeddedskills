...
def main():
    parser = argparse.ArgumentParser(description="Serial port Hex Dump viewer")
    ...
    parser.add_argument("--no-ascii", action="store_true", help="Do not display ASCII column")
    ...
    summary = f"Hex view finished, total {total_bytes} bytes, elapsed {duration}s\n"
